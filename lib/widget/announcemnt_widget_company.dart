...
import 'package:ssen_user/widget/announcement_detail_company.dart';
...
class AnnouncmentWidgetCompany extends StatelessWidget {
  const AnnouncmentWidgetCompany({
    Key? key,
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => AnnouncementDetailCompany(
