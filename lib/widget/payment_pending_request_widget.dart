...
class PaymentPendingRequestWidget extends StatelessWidget {
  const PaymentPendingRequestWidget({Key? key, required this.purchase})
      : super(key: key);
                ...
                ElevatedButton(
                  onPressed: () {
                    FirebasePurchaseMethods().update(
                        purchase.identification, 'requestSent', ['false']);
                  },
                  style: ElevatedButton.styleFrom(
                    primary: Colors.blue,
                  ),
                  child: Text('Cance Request'),
                ),
              ],
            ),
          ],
